...
// PremiumBanner and PremiumBadge removed to avoid upgrade barriers
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                {/* Premium badge removed to avoid gating UI */}
        ...
        {/* Promotional premium banner removed */}
        ...
        {/* Business Account Application available to all registered users */}
        {userProfile &&
          !userProfile.isBusiness &&
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-blue-700 text-sm mb-3">
                    Apply for a Business Account to get bulk order tools, invoicing, and priority support.
                  </p>
