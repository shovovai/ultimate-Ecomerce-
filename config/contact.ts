...
export const contactConfig = {
  company: {
    ...
    email: process.env.NEXT_PUBLIC_COMPANY_EMAIL || "support@webhaat.com",
    ...
    description:
      ...
      "Discover amazing products at WebHaat, your trusted online shopping destination for quality items and exceptional customer service.",
  },
  businessHours: {
    weekday:
  ...
  legal: {
    copyright:
      ...
      "© 2024 WebHaat. All rights reserved.",
